...
public class Packet {
    ...
    public static final byte HEAD_ACK = (byte) 0x20;

    public static final byte HEAD_CLOSE = (byte) 0x10;
    ...
    public String toString() {
        return "Packet{" + "head=" + head + ", cmd=" + cmd + ", address=" + address + ", id=" + id + '}';
    }
